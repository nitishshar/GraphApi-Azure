...
namespace B2CGraphShell
{
    public class B2CGraphClient
    {
        ...
        public async Task<string>  GetAppRoles()
        {
            return await SendGraphGetRequest("/applications?" + "$select = appRoles &$filter = appId eq '"+clientId+"'",null);            
        }
        ...
        public async Task<string> GetUserAppRoleAssigments(string objectId)
        {
            return await SendGraphGetRequest("/users/" + objectId, "appRoleAssignments?$filter=resourceId eq b9597d92-807c-45a0-87f3-b525949793e9");
        }
        ...
        public async Task<string> SendGraphGetRequest(string api, string query)
        {
            ...
            HttpClient http = new HttpClient();
            string url = "https://graph.microsoft.com/beta/"+api;
